...
const ChatPanel = (function() {
    ...
    const initialize = function() {
        ...
        // Handle the keydown of signed in users
        $("#chat-input-form").on("keydown", function(event) {
                // console.log("typing");
                Socket.startTyping();
        });
 	};
    ...
    $("#typing").hide();
    // This function update the typing info
    ...
    return { initialize, update, addMessage, addTyping, clearTyping };
})();
